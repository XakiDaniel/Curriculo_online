<?php
    ...
    if(isset($_POST['bt_cadastrar'])) {
        ...
        $ano_fim = mysqli_real_escape_string($con, $_POST['ano_fim']);
        $situacao    = mysqli_real_escape_string($con, $_POST['situacao']);
        $idusuario   = mysqli_real_escape_string($con, $_SESSION['idusuario']);

        // INSTRUÇÃO SQL
        $sql = "INSERT INTO formacoes (nivel, nome_curso, instituicao, ano_inicio, ano_fim, situacao, idusuario) VALUES ('$nivel', '$nome_curso', '$instituicao', '$ano_inicio', '$ano_fim', '$situacao', '$idusuario')";
